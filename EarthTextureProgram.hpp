...
struct EarthTextureProgram {
	...
	enum : size_t {DAYTIME_TEX = 0U, NIGHT_TEX = 1U, CLOUD_TEX = 2U, TEXTURE_COUNT = 3U};
};

extern Load< EarthTextureProgram > earth_texture_program;
...
extern Scene::Drawable::Pipeline earth_texture_program_pipeline;
